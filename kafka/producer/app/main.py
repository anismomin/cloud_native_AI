...
class IBO(SQLModel):
    ibo_number: str = "7022508813"
    event_type: str = "Inactivated"
...
async def lifespan(app: FastAPI)-> AsyncGenerator[None, None]:
    ...
    # loop.run_until_complete(consume_messages('URA_EventStream', 'broker:19092'))
    task = asyncio.create_task(consume_messages('URA_EventStream', 'broker:19092'))
